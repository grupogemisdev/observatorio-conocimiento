...
(
    id                    SERIAL PRIMARY KEY,      -- INT AUTO_INCREMENT en MySQL / SERIAL en Postgres
    nombre                VARCHAR(255)   NOT NULL,
    sector_organizacional VARCHAR(255)   NOT NULL,
    latitud               NUMERIC(10, 8) NOT NULL, -- DECIMAL compatible
    longitud              NUMERIC(10, 8) NOT NULL,
    medicion_nivel        INT            NOT NULL
);
...
(
    ...
    superarea_id    INT,
    organizacion_id INT,
    FOREIGN KEY (superarea_id) REFERENCES area (id),
